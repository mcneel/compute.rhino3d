...
.. py:module:: compute_rhino3d.Brep

.. py:function:: ChangeSeam(face, direction, parameter, tolerance, multiple=False)
...
.. py:function:: CopyTrimCurves(trimSource, surfaceSource, tolerance, multiple=False)
   ...
   :rtype: rhino3dm.Brep
.. py:function:: CreateBaseballSphere(center, radius, tolerance, multiple=False)
   ...
   :rtype: rhino3dm.Brep
.. py:function:: CreateDevelopableLoft(crv0, crv1, reverse0, reverse1, density, multiple=False)
   ...
   :rtype: rhino3dm.Brep[]
.. py:function:: CreateDevelopableLoft1(rail0, rail1, fixedRulings, multiple=False)
   ...
   :return: The output Breps if successful, otherwise an empty array.
   :rtype: rhino3dm.Brep[]
.. py:function:: CreatePlanarBreps(inputLoops, multiple=False)
   ...
   :rtype: rhino3dm.Brep[]
.. py:function:: CreatePlanarBreps1(inputLoops, tolerance, multiple=False)
   ...
   :return: An array of Planar Breps.
   :rtype: rhino3dm.Brep[]
.. py:function:: CreatePlanarBreps2(inputLoop, multiple=False)
   ...
   :return: An array of Planar Breps.
   :rtype: rhino3dm.Brep[]
.. py:function:: CreatePlanarBreps3(inputLoop, tolerance, multiple=False)
   ...
   :return: An array of Planar Breps.
   :rtype: rhino3dm.Brep[]
.. py:function:: CreateTrimmedSurface(trimSource, surfaceSource, multiple=False)
   ...
   :return: A brep with the shape of surfaceSource and the trims of trimSource or None on failure.
   :rtype: rhino3dm.Brep
.. py:function:: CreateTrimmedSurface1(trimSource, surfaceSource, tolerance, multiple=False)
...
.. py:function:: CreateFromCornerPoints1(corner1, corner2, corner3, corner4, tolerance, multiple=False)
   ...
   :return: A boundary representation, or None on error.
   :rtype: rhino3dm.Brep
.. py:function:: CreateEdgeSurface(curves, multiple=False)
   ...
   :rtype: rhino3dm.Brep
.. py:function:: CreatePlanarBreps4(inputLoops, multiple=False)
   ...
   :rtype: rhino3dm.Brep[]
.. py:function:: CreatePlanarBreps5(inputLoops, tolerance, multiple=False)
   ...
   :return: An array of Planar Breps.
   :rtype: rhino3dm.Brep[]
.. py:function:: CreateFromOffsetFace(face, offsetDistance, offsetTolerance, bothSides, createSolid, multiple=False)
   ...
   :rtype: rhino3dm.Brep
.. py:function:: CreateSolid(breps, tolerance, multiple=False)
   ...
   :rtype: rhino3dm.Brep[]
.. py:function:: MergeSurfaces(surface0, surface1, tolerance, angleToleranceRadians, multiple=False)
   ...
   :rtype: rhino3dm.Brep
.. py:function:: MergeSurfaces1(brep0, brep1, tolerance, angleToleranceRadians, multiple=False)
   ...
   :rtype: rhino3dm.Brep
.. py:function:: MergeSurfaces2(brep0, brep1, tolerance, angleToleranceRadians, point0, point1, roundness, smooth, multiple=False)
   ...
   :return: The merged Brep if successful, None if not successful.
   :rtype: rhino3dm.Brep
.. py:function:: CreatePatch(geometry, startingSurface, tolerance, multiple=False)
   ...
   :rtype: rhino3dm.Brep
.. py:function:: CreatePatch1(geometry, uSpans, vSpans, tolerance, multiple=False)
   ...
   :rtype: rhino3dm.Brep
.. py:function:: CreatePatch2(geometry, startingSurface, uSpans, vSpans, trim, tangency, pointSpacing, flexibility, surfacePull, fixEdges, tolerance, multiple=False)
...
.. py:function:: CreateFromSweepInParts(rail1, rail2, shapes, rail_params, closed, tolerance, multiple=False)
   ...
   :return: Array of Brep sweep results
   :rtype: rhino3dm.Brep[]
.. py:function:: CreateFromTaperedExtrude(curveToExtrude, distance, direction, basePoint, draftAngleRadians, cornerType, tolerance, angleToleranceRadians, multiple=False)
   ...
   :rtype: rhino3dm.Brep[]
.. py:function:: CreateFromTaperedExtrude1(curveToExtrude, distance, direction, basePoint, draftAngleRadians, cornerType, multiple=False)
...
.. py:function:: CreateBlendSurface(face0, edge0, domain0, rev0, continuity0, face1, edge1, domain1, rev1, continuity1, multiple=False)
   ...
   :rtype: rhino3dm.Brep[]
.. py:function:: CreateBlendShape(face0, edge0, t0, rev0, continuity0, face1, edge1, t1, rev1, continuity1, multiple=False)
...
.. py:function:: CreateFilletSurface(face0, uv0, face1, uv1, radius, extend, tolerance, multiple=False)
   ...
   :return: Array of Breps if successful.
   :rtype: rhino3dm.Brep[]
.. py:function:: CreateFilletSurface1(face0, uv0, face1, uv1, radius, trim, extend, tolerance, multiple=False)
   ...
   :return: Array of Breps if successful.
   :rtype: rhino3dm.Brep[]
.. py:function:: CreateChamferSurface(face0, uv0, radius0, face1, uv1, radius1, extend, tolerance, multiple=False)
   ...
   :return: Array of Breps if successful.
   :rtype: rhino3dm.Brep[]
.. py:function:: CreateChamferSurface1(face0, uv0, radius0, face1, uv1, radius1, trim, extend, tolerance, multiple=False)
   ...
   :return: Array of Breps if successful.
   :rtype: rhino3dm.Brep[]
.. py:function:: CreateFilletEdges(brep, edgeIndices, startRadii, endRadii, blendType, railType, tolerance, multiple=False)
   ...
   :return: Array of Breps if successful.
   :rtype: rhino3dm.Brep[]
.. py:function:: CreateOffsetBrep(brep, distance, solid, extend, tolerance, multiple=False)
...
.. py:function:: CreateFromJoinedEdges(brep0, edgeIndex0, brep1, edgeIndex1, joinTolerance, multiple=False)
   ...
   :rtype: rhino3dm.Brep
.. py:function:: CreateFromLoft(curves, start, end, loftType, closed, multiple=False)
   ...
   :rtype: rhino3dm.Brep[]
.. py:function:: CreateFromLoftRebuild(curves, start, end, loftType, closed, rebuildPointCount, multiple=False)
   ...
   :return: Constructs a closed surface, continuing the surface past the last curve around to the \
      first curve. Available when you have selected three shape curves.
   :rtype: rhino3dm.Brep[]
.. py:function:: CreateFromLoftRefit(curves, start, end, loftType, closed, refitTolerance, multiple=False)
...
.. py:function:: CreateBooleanUnion(breps, tolerance, multiple=False)
   ...
   :return: An array of Brep results or None on failure.
   :rtype: rhino3dm.Brep[]
.. py:function:: CreateBooleanUnion1(breps, tolerance, manifoldOnly, multiple=False)
   ...
   :return: An array of Brep results or None on failure.
   :rtype: rhino3dm.Brep[]
.. py:function:: CreateBooleanIntersection(firstSet, secondSet, tolerance, multiple=False)
   ...
   :return: An array of Brep results or None on failure.
   :rtype: rhino3dm.Brep[]
.. py:function:: CreateBooleanIntersection1(firstSet, secondSet, tolerance, manifoldOnly, multiple=False)
   ...
   :return: An array of Brep results or None on failure.
   :rtype: rhino3dm.Brep[]
.. py:function:: CreateBooleanIntersection2(firstBrep, secondBrep, tolerance, multiple=False)
   ...
   :return: An array of Brep results or None on failure.
   :rtype: rhino3dm.Brep[]
.. py:function:: CreateBooleanIntersection3(firstBrep, secondBrep, tolerance, manifoldOnly, multiple=False)
   ...
   :return: An array of Brep results or None on failure.
   :rtype: rhino3dm.Brep[]
.. py:function:: CreateBooleanDifference(firstSet, secondSet, tolerance, multiple=False)
   ...
   :return: An array of Brep results or None on failure.
   :rtype: rhino3dm.Brep[]
.. py:function:: CreateBooleanDifference1(firstSet, secondSet, tolerance, manifoldOnly, multiple=False)
   ...
   :return: An array of Brep results or None on failure.
   :rtype: rhino3dm.Brep[]
.. py:function:: CreateBooleanDifference2(firstBrep, secondBrep, tolerance, multiple=False)
   ...
   :return: An array of Brep results or None on failure.
   :rtype: rhino3dm.Brep[]
.. py:function:: CreateBooleanDifference3(firstBrep, secondBrep, tolerance, manifoldOnly, multiple=False)
...
.. py:function:: CreateShell(brep, facesToRemove, distance, tolerance, multiple=False)
   ...
   :return: An array of Brep results or None on failure.
   :rtype: rhino3dm.Brep[]
.. py:function:: JoinBreps(brepsToJoin, tolerance, multiple=False)
   ...
   :rtype: rhino3dm.Brep[]
.. py:function:: MergeBreps(brepsToMerge, tolerance, multiple=False)
   ...
   :rtype: rhino3dm.Brep
.. py:function:: CreateContourCurves(brepToContour, contourStart, contourEnd, interval, multiple=False)
   ...
   :rtype: rhino3dm.Curve[]
.. py:function:: CreateContourCurves1(brepToContour, sectionPlane, multiple=False)
   ...
   :return: An array with intersected curves. This array can be empty.
   :rtype: rhino3dm.Curve[]
.. py:function:: CreateCurvatureAnalysisMesh(brep, state, multiple=False)
   ...
   :rtype: rhino3dm.Mesh[]
.. py:function:: GetRegions(thisBrep, multiple=False)
   ...
   :rtype: BrepRegion[]
.. py:function:: GetWireframe(thisBrep, density, multiple=False)
   ...
   :rtype: rhino3dm.Curve[]
.. py:function:: ClosestPoint(thisBrep, testPoint, multiple=False)
...
.. py:function:: CapPlanarHoles(thisBrep, tolerance, multiple=False)
   ...
   :rtype: rhino3dm.Brep
.. py:function:: Join(thisBrep, otherBrep, tolerance, compact, multiple=False)
   ...
   :rtype: bool
.. py:function:: JoinNakedEdges(thisBrep, tolerance, multiple=False)
   ...
   :rtype: int
.. py:function:: MergeCoplanarFaces(thisBrep, tolerance, multiple=False)
   ...
   :rtype: bool
.. py:function:: MergeCoplanarFaces1(thisBrep, tolerance, angleTolerance, multiple=False)
   ...
   :return: True if faces were merged, False if no faces were merged.
   :rtype: bool
.. py:function:: Split(thisBrep, cutter, intersectionTolerance, multiple=False)
   ...
   :rtype: rhino3dm.Brep[]
.. py:function:: Split1(thisBrep, cutter, intersectionTolerance, multiple=False)
   ...
   :return: A new array of Breps. This array can be empty.
   :rtype: rhino3dm.Brep[]
.. py:function:: Split2(thisBrep, cutters, intersectionTolerance, multiple=False)
   ...
   :return: A new array of Breps. This array can be empty.
   :rtype: rhino3dm.Brep[]
.. py:function:: Split3(thisBrep, cutters, intersectionTolerance, multiple=False)
   ...
   :return: A new array of Breps. This array can be empty.
   :rtype: rhino3dm.Brep[]
.. py:function:: Split4(thisBrep, cutters, normal, planView, intersectionTolerance, multiple=False)
   ...
   :return: A new array of Breps. This array can be empty.
   :rtype: rhino3dm.Brep[]
.. py:function:: Trim(thisBrep, cutter, intersectionTolerance, multiple=False)
   ...
   :rtype: rhino3dm.Brep[]
.. py:function:: Trim1(thisBrep, cutter, intersectionTolerance, multiple=False)
...
.. py:function:: UnjoinEdges(thisBrep, edgesToUnjoin, multiple=False)
   ...
   :return: This Brep is not modified, the trim results are returned in an array.
   :rtype: rhino3dm.Brep[]
.. py:function:: JoinEdges(thisBrep, edgeIndex0, edgeIndex1, joinTolerance, compact, multiple=False)
   ...
   :rtype: bool
.. py:function:: TransformComponent(thisBrep, components, xform, tolerance, timeLimit, useMultipleThreads, multiple=False)
   ...
   :return: True if successful, False otherwise.
   :rtype: bool
.. py:function:: GetArea(thisBrep, multiple=False)
   ...
   :rtype: float
.. py:function:: GetArea1(thisBrep, relativeTolerance, absoluteTolerance, multiple=False)
   ...
   :return: The area of the Brep.
   :rtype: float
.. py:function:: GetVolume(thisBrep, multiple=False)
   ...
   :rtype: float
.. py:function:: GetVolume1(thisBrep, relativeTolerance, absoluteTolerance, multiple=False)
   ...
   :return: The volume of the Brep.
   :rtype: float
.. py:function:: RebuildTrimsForV2(thisBrep, face, nurbsSurface, multiple=False)
...
.. py:function:: MakeValidForV2(thisBrep, multiple=False)
   ...
   :rtype: bool
.. py:function:: Repair(thisBrep, tolerance, multiple=False)
   ...
   :rtype: bool
.. py:function:: RemoveHoles(thisBrep, tolerance, multiple=False)
   ...
   :rtype: rhino3dm.Brep
.. py:function:: RemoveHoles1(thisBrep, loops, tolerance, multiple=False)

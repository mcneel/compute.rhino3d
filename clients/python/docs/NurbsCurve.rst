...
.. py:module:: compute_rhino3d.NurbsCurve

.. py:function:: MakeCompatible(curves, startPt, endPt, simplifyMethod, numPoints, refitTolerance, angleTolerance, multiple=False)
...
.. py:function:: CreateParabolaFromVertex(vertex, startPoint, endPoint, multiple=False)
   ...
   :rtype: rhino3dm.NurbsCurve
.. py:function:: CreateParabolaFromFocus(focus, startPoint, endPoint, multiple=False)
   ...
   :return: A 2 degree NURBS curve if successful, False otherwise.
   :rtype: rhino3dm.NurbsCurve
.. py:function:: CreateFromArc(arc, degree, cvCount, multiple=False)
...
.. py:function:: CreateHSpline1(points, startTangent, endTangent, multiple=False)
   ...
   :return: NURBS curve approximation of an arc on success
   :rtype: rhino3dm.NurbsCurve
.. py:function:: CreateSubDFriendly(points, interpolatePoints, periodicClosedCurve, multiple=False)
   ...
   :rtype: rhino3dm.NurbsCurve
.. py:function:: CreateSubDFriendly1(curve, multiple=False)
   ...
   :return: A SubD friendly NURBS curve is successful, None otherwise.
   :rtype: rhino3dm.NurbsCurve
.. py:function:: CreateSubDFriendly2(curve, pointCount, periodicClosedCurve, multiple=False)
   ...
   :return: A SubD friendly NURBS curve is successful, None otherwise.
   :rtype: rhino3dm.NurbsCurve
.. py:function:: CreatePlanarRailFrames(thisNurbsCurve, parameters, normal, multiple=False)
...
.. py:function:: CreateRailFrames(thisNurbsCurve, parameters, multiple=False)
...
.. py:function:: CreateFromCircle(circle, degree, cvCount, multiple=False)
   ...
   :rtype: rhino3dm.NurbsCurve
.. py:function:: SetEndCondition(thisNurbsCurve, bSetEnd, continuity, point, tangent, multiple=False)
   ...
   :rtype: bool
.. py:function:: SetEndCondition1(thisNurbsCurve, bSetEnd, continuity, point, tangent, curvature, multiple=False)
...
.. py:function:: SetGrevillePoints(thisNurbsCurve, points, multiple=False)
   ...
   :rtype: bool
.. py:function:: CreateSpiral(axisStart, axisDir, radiusPoint, pitch, turnCount, radius0, radius1, multiple=False)
   ...
   :rtype: rhino3dm.NurbsCurve
.. py:function:: CreateSpiral1(railCurve, t0, t1, radiusPoint, pitch, turnCount, radius0, radius1, pointsPerTurn, multiple=False)
